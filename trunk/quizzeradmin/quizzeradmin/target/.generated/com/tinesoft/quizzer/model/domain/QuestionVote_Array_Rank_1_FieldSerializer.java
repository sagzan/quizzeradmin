...
public class QuestionVote_Array_Rank_1_FieldSerializer {
  ...
  public static com.tinesoft.quizzer.model.domain.QuestionVote[] instantiate(com.google.gwt.user.client.rpc.SerializationStreamReader streamReader) throws com.google.gwt.user.client.rpc.SerializationException{
    int rank = streamReader.readInt();
    return new com.tinesoft.quizzer.model.domain.QuestionVote[rank];
  }
